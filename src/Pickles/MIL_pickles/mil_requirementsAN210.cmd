...
%BIN_DIR%\Pickles.exe -f=C:\MIL_Src\docs\requirements\ -o=.\Output --sn=AssistDent --sv=2.1 --df=Word --et="FR;NFR"
rename  .\Output\AssistDent.docx %PROJ_NAME%_UserRequirements_Desktop.docx 

%BIN_DIR%\Pickles.exe -f=C:\MIL_Src\docs\requirements\ -o=.\Output --sn=AssistDent --sv=2.1 --df=Word --et="UR;NFR"
rename  .\Output\AssistDent.docx %PROJ_NAME%_FunctionalRequirements_Desktop.docx 

%BIN_DIR%\Pickles.exe -f=C:\MIL_Src\docs\requirements\ -o=.\Output --sn=AssistDent --sv=2.1 --df=Word --et="UR;FR"
