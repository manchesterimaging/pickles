...
%BIN_DIR%\Pickles.exe -f=C:\MIL_Src\docs\requirements\ -o=.\Output --sn=AssistDent --sv=1.6 --df=Word --et="FR;NFR"
rename  .\Output\AssistDent.docx %PROJ_NAME%_UserRequirements.docx 

%BIN_DIR%\Pickles.exe -f=C:\MIL_Src\docs\requirements\ -o=.\Output --sn=AssistDent --sv=1.6 --df=Word --et="UR;NFR"
rename  .\Output\AssistDent.docx %PROJ_NAME%_FunctionalRequirements.docx 

%BIN_DIR%\Pickles.exe -f=C:\MIL_Src\docs\requirements\ -o=.\Output --sn=AssistDent --sv=1.6 --df=Word --et="UR;FR"
